import svgPaths from "./svg-zfgph2uzo7";
import imgDivServiceVisualBlock from "figma:asset/63896a7812deb6f7d28879869efe4e6f287f64a0.png";
  ...
  return (
    <div className="content-stretch flex flex-col items-start pb-[0.66px] pt-[3.22px] relative shrink-0 w-full" data-name="h1">
      <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[50.4px] w-full">
        <p className="leading-[55.44px] mb-0">Nettoyage de prothèse</p>
  ...
  return (
    <div className="content-stretch flex flex-col items-start pt-[8px] relative shrink-0 w-full" data-name="p.lead">
      <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[17px] w-full">
        <p className="leading-[28.9px]">Hygiène professionnelle pour une prothèse comme neuve</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start pb-[20px] pt-[24px] relative shrink-0 w-full" data-name="p">
      <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3a3637] text-[16px] w-full">
        <p className="leading-[28px] mb-0">Un nettoyage professionnel régulier est essentiel pour la longévité de votre</p>
        <p className="leading-[28px] mb-0">prothèse et la santé de vos tissus buccaux. Notre technique aux ultrasons</p>
        <p className="leading-[28px]">élimine les dépôts que le brossage quotidien ne peut pas atteindre.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[400px] items-center justify-center min-h-px min-w-px overflow-clip relative rounded-[24px]" data-name="div.service-visual-block">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[24px]">
        <img alt="" className="absolute h-[210%] left-0 max-w-none top-[-0.06%] w-full" src={imgDivServiceVisualBlock} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="strong">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
        <p className="leading-[normal]">Inspection visuelle</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0" data-name="div.step-content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.5px] items-start relative">
        ...
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">{`Examen de l'état général de la prothèse et identification des zones à traiter.`}</p>
        </div>
      </div>
    </div>
  );
...
function Strong1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="strong">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
        <p className="leading-[normal]">Nettoyage aux ultrasons</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="div.step-content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.5px] items-start relative">
        <Strong1 />
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">{`Utilisation d'un appareil à ultrasons pour déloger les dépôts de tartre et les bactéries incrustées.`}</p>
        </div>
      </div>
    </div>
  );
...
function Strong2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="strong">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
        <p className="leading-[normal]">Polissage professionnel</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="div.step-content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.5px] items-start relative">
        <Strong2 />
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">{`Polissage à l'aide de produits spécialisés pour restaurer la brillance et lisser les surfaces.`}</p>
        </div>
      </div>
    </div>
  );
...
function Strong3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="strong">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
        <p className="leading-[normal]">Désinfection complète</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="div.step-content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.5px] items-start relative">
        <Strong3 />
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Désinfection en profondeur pour éliminer toutes les bactéries et champignons.</p>
        </div>
      </div>
    </div>
  );
...
function Strong4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="strong">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
        <p className="leading-[normal]">{`Conseils d'entretien`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="div.step-content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.5px] items-start relative">
        <Strong4 />
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6667] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Recommandations personnalisées pour maintenir votre prothèse propre entre les visites.</p>
        </div>
      </div>
    </div>
  );
...
function H2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[36px] right-[36px] top-[36px]" data-name="h3">
    ...
    <div className="relative shrink-0" data-name="span.info-label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.5)] whitespace-nowrap">
          <p className="leading-[normal]">Durée de la visite</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0" data-name="span.info-value">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
          <p className="leading-[normal]">30 à 60 minutes</p>
        </div>
      </div>
    </div>
  );
...
function DivInfoRow() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[36px] pb-[15px] pt-[14px] right-[36px] top-[84px]" data-name="div.info-row">
...
function SpanInfoLabel1() {
  return (
    <div className="relative shrink-0" data-name="span.info-label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.5)] whitespace-nowrap">
          <p className="leading-[normal]">Fréquence recommandée</p>
        </div>
      </div>
    </div>
  );
...
function SpanInfoValue1() {
  return (
    <div className="relative shrink-0" data-name="span.info-value">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
          <p className="leading-[normal]">1 à 2 fois par an</p>
        </div>
      </div>
    </div>
  );
...
function DivInfoRow1() {
  return (
    <div className="absolute content-stretch flex gap-[126.86px] items-center left-[36px] pb-[15px] pt-[14px] right-[36px] top-[130px]" data-name="div.info-row">
      <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.08)] border-b border-solid inset-0 pointer-events-none" />
      <SpanInfoLabel1 />
      <SpanInfoValue1 />
    </div>
    ...
    <div className="relative shrink-0" data-name="span.info-value">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#00a8b2] text-[13px] whitespace-nowrap">
          <p className="leading-[normal]">Souvent couverte</p>
        </div>
      </div>
    </div>
  );
...
function DivInfoRow2() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[36px] pb-[15px] pt-[14px] right-[36px] top-[176px]" data-name="div.info-row">
      <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.08)] border-b border-solid inset-0 pointer-events-none" />
      <SpanInfoLabel2 />
      <SpanInfoValue2 />
    </div>
...
function SpanInfoLabel3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="span.info-label">
      <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[normal]">Sans rendez-vous urgent</p>
      </div>
    </div>
  );
}

function SpanInfoValue3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="span.info-value">
      <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[normal]">Sur appel</p>
      </div>
    </div>
  );
}
...
function DivInfoRow3() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[36px] py-[14px] right-[36px] top-[222px]" data-name="div.info-row">
      <SpanInfoLabel3 />
      <SpanInfoValue3 />
    </div>
  );
...
function DivServiceInfoBox() {
  return (
    <div className="bg-[#1e1d24] h-[379px] rounded-[20px] shrink-0 sticky top-0 w-full" data-name="div.service-info-box">
      <H2 />
      <DivInfoRow />
      <DivInfoRow1 />
      <DivInfoRow2 />
      <DivInfoRow3 />
      <div className="absolute bg-[#00a8b2] content-stretch flex items-center justify-center left-[36px] px-[32px] py-[16px] right-[36px] rounded-[12px] top-[291px]" data-name="Component 2">
        <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-center text-white whitespace-nowrap">
...
function DivServiceContentInner() {
  return (
    <div className="absolute content-stretch flex gap-[80px] h-[603.5px] items-start justify-center left-[120.09px] max-w-[1200px] right-[119.91px] top-[725.77px]" data-name="div.service-content-inner">
    ...
    <div className="relative shrink-0 w-full" data-name="div.faq-q">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[28px] py-[24px] relative w-full">
          <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
            <p className="leading-[normal]">À quelle fréquence faire nettoyer ma prothèse?</p>
          </div>
          <DivFaqToggle />
        </div>
      </div>
    ...
    <div className="relative shrink-0 w-full" data-name="div.faq-a">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[15.75px] pt-[16.5px] px-[28px] relative w-full">
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3a3637] text-[15px] w-full">
          <p className="leading-[26.25px]">Nous recommandons un nettoyage professionnel au moins une fois par an, idéalement deux fois.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="div.faq-q">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[28px] py-[24px] relative w-full">
          <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
            <p className="leading-[normal]">Le nettoyage aux ultrasons abîme-t-il la prothèse?</p>
          </div>
          <DivFaqToggle1 />
        </div>
      </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="div.faq-a">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[16px] pt-[17px] px-[28px] relative w-full">
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3a3637] text-[15px] w-full">
          <p className="leading-[26.25px]">{`Non, la technique aux ultrasons est douce et efficace. Elle n'endommage pas les matériaux lorsqu'elle est réalisée par un professionnel qualifié.`}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="div.faq-q">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[28px] py-[24px] relative w-full">
          <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1e1d24] text-[15px] whitespace-nowrap">
            <p className="leading-[normal]">Mon assurance couvre-t-elle le nettoyage professionnel?</p>
          </div>
          <DivFaqToggle2 />
        </div>
      </div>
...
function DivFaqA2() {
  return (
    <div className="relative shrink-0 w-full" data-name="div.faq-a">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[16px] pt-[17px] px-[28px] relative w-full">
        <div className="flex flex-col font-['Rethink_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3a3637] text-[15px] w-full">
          <p className="leading-[26.25px] mb-0">{`Plusieurs assurances couvrent le nettoyage et l'entretien de prothèses dentaires. Vérifiez votre contrat ou`}</p>
          <p className="leading-[26.25px]">contactez-nous.</p>
        </div>
      </div>
    </div>
  );
...
function DivFaqSection() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex flex-col items-start left-[0.09px] px-[320px] py-[80px] right-[-0.09px] top-[1410.27px]" data-name="div.faq-section">
      <DivFaqInner />
    </div>
  );
}
...
function CtaBanner() {
  return (
    <div className="absolute bg-[#00a8b2] content-stretch flex flex-col gap-[16px] items-center left-0 overflow-clip px-[40px] py-[80px] top-[2185px] w-[1440px]" data-name="CTA Banner">
...
export default function NettoyageDeProtheseServices1440Px() {
  return (
    <div className="bg-[#f1f1f2] relative size-full" data-name="Nettoyage de prothèse (Services) - 1440px">
